...
function v1ToV6(uuid) {
	const v6Bytes = _v1ToV6(typeof uuid === "string" ? parse_default(uuid) : uuid);
...
function v35(version$1, hash, value, namespace, buf, offset) {
...
function v6ToV1(uuid) {
	const v1Bytes$1 = _v6ToV1(typeof uuid === "string" ? parse_default(uuid) : uuid);
	return typeof uuid === "string" ? unsafeStringify(v1Bytes$1) : v1Bytes$1;
}
...
//#endregion
export { max_default as MAX, nil_default as NIL, parse_default as parse, stringify_default as stringify, v1_default as v1, v1ToV6, v3_default as v3, v4_default as v4, v5_default as v5, v6_default as v6, v6ToV1, v7_default as v7, validate_default as validate, version_default as version };
